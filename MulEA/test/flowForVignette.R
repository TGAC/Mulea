...
setBaseTest <- SetBasedTest(gmt = modelDfFromFile, testData = dataFromExperimentT)
setBaseTestWithPool <- SetBasedTest(gmt = modelDfFromFile, testData = dataFromExperimentT, pool = dataFromExperimentPool)
setBaseTestWithPoolAndAdjust <- SetBasedTest(gmt = modelDfFromFile, testData = dataFromExperimentT, pool = dataFromExperimentPool, adjustMethod = "BH")

setBaseTestRes <- MulEA::runTest(setBaseTest)
setBaseTestWithPoolRes <- MulEA::runTest(setBaseTestWithPool)
setBaseTestWithPoolAndAdjustRes <- MulEA::runTest(setBaseTestWithPoolAndAdjust)
