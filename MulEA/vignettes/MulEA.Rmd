...
There are 3 way to work with data in MulEA; Directly from our global DB, with a local database or local files. Detailed instructions follow.
...
##### General Approach
According to article [Multiple Comparisons Problem](https://en.wikipedia.org/wiki/Multiple_comparisons_problem) you can adjust p-values of tested models by adding `adjustMethod` argument to contyngency table based tests methods. Value of this argument is one of listed values: "holm", "hochberg", "hommel", "bonferroni", "BH", "BY", "fdr". You can find references to the method under this [link](http://stat.ethz.ch/R-manual/R-devel/library/stats/html/p.adjust.html).

Data frame with adjustment of p-values has one extra column. You can see that column in below model:
...
## Code Snippet
You can copy paste this code to start working with MulEA more easely. All Snippet of the code regarding to some capture of this vignettes:
